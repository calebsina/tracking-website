        ...
        <div class="container contact-page py-5 px-lg-0">
            <div class="row g-5 mx-lg-0">
                <div class="col-md-6 contact-form wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">TNeed dependable, cost effective transportation of your commodities? fill out our easy form below to get a fast quote on your job</p>
                ...
                <div class="col-md-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s">
                    <div id="map" class="position-relative h-100">
...
<?php
    $LATITUDE = -33.83273393866467;
    $LONGITUDE = 151.0210207459953;
    ...
    function initMap() {
        ...
        map: map,
        title: 'Kendall St, Clyde NSW Australia'
        });
    }
</script>";
?>
